#!/usr/bin/env python3
"""
box_size_debug: YOLOv5 + 크기 필터 디버그용 단독 Python 스크립트 (ROS2 + TurtleBot4)

기능 요약
---------
- ROS2 rclpy 노드를 내부에서 띄우지만, tb4_target_selector 패키지와 분리된
  프로젝트 루트 단일 스크립트로 사용한다.
- RGB 카메라 이미지를 구독하여 YOLOv5 추론 수행
- 파라미터 distance_to_box_m 로 박스까지의 거리를 가정
...
class BoxSizeDebugNode(Node):
    ...
    def timer_callback(self) -> None:
        ...
        # 파라미터 distance_to_box_m 를 그대로 사용
